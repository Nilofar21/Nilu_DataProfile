...
**Project: Checkout Optimization & Payment Gateway Integration.

Impact: Documented the "To-Be" process for seamless payment switching, reducing transaction failures by mapping error codes via SQL.

Artifacts:  BRD, API Mapping Docs, User Journey Maps.
...
- **Methodologies:** Scrum, Kanban, Waterfall-to-Agile transitions.

## 📂 Featured Projects
- [**Fintech: BNPL System Design**](./link-to-repo) - End-to-end documentation for a credit-lending platform.
- [**SQL Data Mapping**](./link-to-repo) - Scripts for database schema design and complex joins.
- [**Agile Transformation Case Study**](./link-to-repo) - Implementing 'Definition of Ready' (DoR) for a Scrum team.

📫 Connect with me: **https://www.linkedin.com/in/nilu21/** | Let's build something efficient.

---
📫 **Connect with me:** https://www.linkedin.com/in/nilu21/
